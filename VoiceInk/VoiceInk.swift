...
struct EmberTypeApp: App {
    ...
    init() {
        ...
        let logger = Logger(subsystem: "com.embervista.embertype", category: "Initialization")
        let schema = Schema([
            Transcription.self,
            VocabularyWord.self,
        ...
        // Attempt 2: Try in-memory storage
            ...
            DispatchQueue.main.async {
                ...
                alert.informativeText = "EmberType couldn't access its storage location. Your transcriptions will not be saved between sessions."
    ...
    private static func createPersistentContainer(schema: Schema, logger: Logger) -> ModelContainer? {
        do {
            ...
            let appSupportURL = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
                .appendingPathComponent("com.embervista.EmberType", isDirectory: true)
        ...
        WindowGroup {
            if hasCompletedOnboarding {
                ContentView()
                    ...
                    .onAppear {
                        ...
                        if containerInitializationFailed {
                            ...
                            alert.informativeText = "EmberType cannot initialize its storage system. The app cannot continue.\n\nPlease try reinstalling the app or contact support if the issue persists."
                ...
                OnboardingView(hasCompletedOnboarding: $hasCompletedOnboarding)
                    ...
                    .background(WindowAccessor { window in
                        if window.identifier == nil || window.identifier != NSUserInterfaceItemIdentifier("com.embervista.embertype.onboardingWindow") {
