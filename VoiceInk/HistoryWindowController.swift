...
class HistoryWindowController: NSObject, NSWindowDelegate {
    ...
    private let windowIdentifier = NSUserInterfaceItemIdentifier("com.embervista.embertype.historyWindow")
    private let windowAutosaveName = NSWindow.FrameAutosaveName("EmberTypeHistoryWindowFrame")
    ...
    private func createHistoryWindow(modelContainer: ModelContainer, whisperState: WhisperState) -> NSWindow {
        ...
        window.title = "EmberType — Transcription History"
