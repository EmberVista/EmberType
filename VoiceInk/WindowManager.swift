...
class WindowManager: NSObject {
    ...
    private static let mainWindowIdentifier = NSUserInterfaceItemIdentifier("com.embervista.embertype.mainWindow")
    private static let onboardingWindowIdentifier = NSUserInterfaceItemIdentifier("com.embervista.embertype.onboardingWindow")
    private static let mainWindowAutosaveName = NSWindow.FrameAutosaveName("EmberTypeMainWindowFrame")
    ...
    func configureOnboardingPanel(_ window: NSWindow) {
        ...
        window.title = "EmberType Onboarding"
