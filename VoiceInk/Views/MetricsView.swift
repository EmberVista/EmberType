        ...
        VStack {
            ...
            if case .trial(let daysRemaining) = licenseViewModel.licenseState {
                TrialMessageView(
                    ...
                    onAddLicenseKey: {
                        // Post notification to navigate to EmberType Pro tab
                        NotificationCenter.default.post(
                            name: .navigateToDestination,
                            object: nil,
                            userInfo: ["destination": "EmberType Pro"]
                        )
                    }
                )
                .padding()
                ...
                TrialMessageView(
                    message: "Your trial has expired. Upgrade to continue using EmberType",
                    type: .expired,
                    onAddLicenseKey: {
