...
struct MetricsContent: View {
    ...
    private var heroSection: some View {
            ...
            HStack {
                ...
                (Text("You have saved ")
                 ...
                 Text(formattedTimeSaved)
                    .fontWeight(.black)
                    .font(DesignTokens.inter(size: 36, weight: .bold))
        ...
        .overlay(
            RoundedRectangle(cornerRadius: DesignTokens.cornerRadiusCard, style: .continuous)
                .strokeBorder(DesignTokens.border, lineWidth: DesignTokens.borderWidth)
        )
    ...
    private var metricsSection: some View {
        LazyVGrid(columns: [GridItem(.adaptive(minimum: 240), spacing: 16)], spacing: 16) {
            MetricCard(
                ...
                detail: "EmberType sessions completed",
            ...
            MetricCard(
                ...
                value: averageWordsPerMinute > 0
                    ...
                    : "–",
                detail: "EmberType vs. typing by hand",
                color: DesignTokens.accent
            )
    ...
    private var heroSubtitle: String {
        guard !transcriptions.isEmpty else {
            return "Your EmberType journey starts with your first recording."
        }
    ...
    private var heroGradient: LinearGradient {
        // Dark gradient matching website style - not orange background
        LinearGradient(
