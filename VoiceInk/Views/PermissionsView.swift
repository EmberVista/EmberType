            ...
            HStack(spacing: 16) {
                ...
                HStack(spacing: 12) {
                    Button(action: {
                        ...
                        // Poll multiple times to catch cached/delayed permission state changes
                        var attempts = 0
        ...
        ScrollView {
            VStack(spacing: 32) {
                ...
                CompactHeroSection(
                    ...
                    description: "EmberType requires the following permissions to function properly"
                )
                ...
                VStack(spacing: 16) {
                    ...
                    PermissionCard(
                        ...
                        description: "Set up a keyboard shortcut to use EmberType anywhere",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow EmberType to record your voice for transcription",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow EmberType to paste transcribed text directly at your cursor position",
                        ...
                        infoTipMessage: "EmberType uses Accessibility permissions to paste the transcribed text directly into other applications at your cursor's position. This allows for a seamless dictation experience across your Mac."
                    )
                    ...
                    PermissionCard(
                        ...
                        description: "Allow EmberType to understand context from your screen for transcript Enhancement",
                        ...
                        infoTipMessage: "EmberType captures on-screen text to understand the context of your voice input, which significantly improves transcription accuracy. Your privacy is important: this data is processed locally and is not stored.",
                        infoTipLink: "https://embertype.com/docs/contextual-awareness"
                    )
                }
            }
            .padding(24)
