    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                SettingsSection(
                    icon: "command.circle",
                    title: "EmberType Shortcuts",
                    subtitle: "Choose how you want to trigger EmberType"
                ) {
                ...
                SettingsSection(
                    ...
                    subtitle: "Additional shortcuts for EmberType"
                ) {
                    VStack(alignment: .leading, spacing: 18) {
                        ...
                        ExpandableToggleSection(
                            ...
                            helpText: "Use middle mouse button to toggle EmberType recording.",
                ...
                SettingsSection(
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        ExpandableToggleSection(
                            ...
                            helpText: "When enabled, EmberType will restore your original clipboard content after pasting the transcription.",
            ...
            HStack(spacing: 12) {
                ...
                if showWarning {
                    ...
                    Image(systemName: "exclamationmark.triangle.fill")
                        .foregroundColor(.red)
                        .help("Permission required for EmberType to function properly")
                }
            }
