                            ...
                            VStack(spacing: 60) {
                                ...
                                VStack(spacing: 16) {
                                    Text("Welcome to the Future of Typing")
                                        .font(DesignTokens.inter(size: min(geometry.size.width * 0.055, 42), weight: .bold))
                                    ...
                                    Text("A New Way to Type")
                                        .font(DesignTokens.inter(size: min(geometry.size.width * 0.032, 24), weight: .medium))
...
struct TypewriterRoles: View {
    ...
    var body: some View {
        VStack {
            HStack(spacing: 0) {
                Text(displayedText)
                    .font(DesignTokens.inter(size: 42, weight: .bold))
                    .foregroundStyle(
                        LinearGradient(
                            colors: [
                                Color.accentColor,
