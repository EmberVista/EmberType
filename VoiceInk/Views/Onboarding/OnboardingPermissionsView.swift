...
struct OnboardingPermissionsView: View {
    ...
    private let permissions: [OnboardingPermission] = [
        ...
        OnboardingPermission(
            ...
            description: "Select the audio input device you want to use with EmberType.",
            icon: "headphones",
            type: .audioDeviceSelection
        ),
        OnboardingPermission(
            title: "Accessibility Access",
            description: "Allow EmberType to help you type anywhere in your Mac.",
            icon: "accessibility",
            type: .accessibility
        ),
        OnboardingPermission(
        ...
        OnboardingPermission(
            ...
            description: "Set up a keyboard shortcut to quickly access EmberType from anywhere.",
            icon: "keyboard",
                                ...
                                HStack(spacing: 8) {
                                    ...
                                    if permissions[currentPermissionIndex].type == .screenRecording {
                                        InfoTip(
                                            ...
                                            message: "EmberType captures on-screen text to understand the context of your voice input, which significantly improves transcription accuracy. Your privacy is important: this data is processed locally and is not stored.",
                                            learnMoreURL: "https://embertype.com/docs/contextual-awareness"
                                        )
                                    }
                                }
    ...
    private func checkExistingPermissions() {
        ...
        // Check accessibility permission (prompt: false to avoid triggering a dialog)
        let axOptions: NSDictionary = [kAXTrustedCheckOptionPrompt.takeUnretainedValue() as String: false]
        permissionStates[2] = AXIsProcessTrustedWithOptions(axOptions)
    ...
    private func hotkeyView(
        ...
        VStack(spacing: 16) {
            styledPicker(
                ...
                options: HotkeyManager.HotkeyOption.allCases.filter { $0 != .none },
