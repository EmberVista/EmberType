...
struct OnboardingTutorialView: View {
                ...
                HStack(spacing: 0) {
                    ...
                    VStack(alignment: .leading, spacing: 40) {
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            Text("Try It Out!")
                                .font(DesignTokens.inter(size: 44, weight: .bold))
                                .foregroundColor(.white)
                            
                            Text("Let's test your EmberType setup.")
                                .font(DesignTokens.inter(size: 24, weight: .medium))
                        ...
                        VStack(alignment: .leading, spacing: 20) {
                            HStack {
                                Text("Your Shortcut")
                                    .font(DesignTokens.inter(size: 28, weight: .semibold))
                                    .foregroundColor(.white)
                            ...
                            if hotkeyManager.selectedHotkey1 == .custom,
                               let shortcut = KeyboardShortcuts.getShortcut(for: .toggleMiniRecorder) {
                                ...
                                Text(hotkeyManager.selectedHotkey1.displayName)
                                    .font(DesignTokens.inter(size: 24, weight: .bold))
                        ...
                        Button(action: {
                            ...
                            Text("Complete Setup")
                                .font(DesignTokens.inter(size: 18, weight: .semibold))
                                .foregroundColor(.white)
                    ...
                    VStack {
                        ...
                        ZStack {
                            ...
                            TextEditor(text: $transcribedText)
                                .font(DesignTokens.inter(size: 32, weight: .bold))
                                .focused($isFocused)
    ...
    private func instructionStep(number: Int, text: String) -> some View {
        HStack(spacing: 20) {
            Text("\(number)")
                .font(DesignTokens.inter(size: 20, weight: .bold))
                .foregroundColor(.white)
            ...
            Text(text)
                .font(DesignTokens.inter(size: 18, weight: .medium))
