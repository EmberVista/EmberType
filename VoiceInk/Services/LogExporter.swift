...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.embervista.embertype", category: "LogExporter")
    private let subsystem = "com.embervista.embertype"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== EmberType Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "EmberType_Logs_\(timestamp).log"
