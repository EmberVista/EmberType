...
final class KeychainService {
    ...
    private let logger = Logger(subsystem: "com.embervista.embertype", category: "KeychainService")
    private let service = "com.embervista.EmberType"
    ...
    private func baseQuery(forKey key: String, syncable: Bool) -> [String: Any] {
        ...
        // Explicitly set syncable attribute for both true and false cases
        // This ensures queries match items with the same syncable setting
